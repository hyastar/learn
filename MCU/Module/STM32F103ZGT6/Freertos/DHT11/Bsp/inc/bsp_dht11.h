...
#define DHT11_DQ_GPIO_PIN                   SYS_GPIO_PIN_11
 ...
 */
#define DHT11_DQ_OUT(x)         do{ x ? (DHT11_DQ_GPIO_PORT->BSRR = DHT11_DQ_GPIO_PIN) : (DHT11_DQ_GPIO_PORT->BSRR = (uint32_t)DHT11_DQ_GPIO_PIN << 16); }while(0)
