/*  Decoder.js
	...
	用法：参见博客地址
    ---------------------------------------------------------------------------------------------------
**	https://blog.ahuaaa.cn/2023/01/12/js-gbk/
**  ==================================================================================================
*/
 ...
 */
// 在函数名前面加上 export const，将其作为模块导出
export const GBKHexstrToString2 = function (input) {
    // 根据博客文章提示，去掉偶数判断以兼容RSSI
    // if (input.length % 2 !== 0) {
 ...
 */
var binaryarrayToHexstr = function (array) {
    var output = '';
 ...
 * 将一个字节的整型转换成16进制
 */
var oneByteIntToHex = function (i) {
    var output = '';
    i = parseInt(i);
